...
Create a three subplots within a figure.  Use the three different types of plots taught in lecture and your custom colormap.  Upload to the python-week-3 box on L@UW.
